...
// Page Builder blocks exposed to Layout Editor.
//
// By default, Standard Drupal blocks, Fieldblocks, Views blocks, & Menu Blocks
// are available to the Layout Editor for placement on Page Builder pages.
// To make available blocks from a contributed module, use the following,
// where the array "key" is the machine name of the module, and the "value" is
// the human-readable name:
//
// To add the "chatblock" module, for example, you would provide the following:
// $conf['utexas_page_builder_add_block_modules']['chatblock'] = 'ChatBlock';
//
// The 4 default modules can be removed. To do so, uncomment the desired line:
// Disable blocks generated by Menu Block:
// $conf['utexas_page_builder_remove_block_modules'][] = 'menu-block';
// Disable blocks generated via the Views module:
// $conf['utexas_page_builder_remove_block_modules'][] = 'views';
// Disable standard Drupal blocks:
...
if (defined('PANTHEON_ENVIRONMENT') && file_exists(dirname(__FILE__) . '/pantheon-settings.php')) {
  require_once(dirname(__FILE__) . '/pantheon-settings.php');
}

// Local development configuration.
// Instance-specific configuration, such as database credentials (boilerplate
// below), can be placed in a separate file called local-settings.php
/*
 $databases['default']['default'] = array(
   'driver' => 'mysql',
   'database' => '',
...
*/
if (!defined('PANTHEON_ENVIRONMENT') && file_exists(dirname(__FILE__) . '/local-settings.php')) {
