...
export BEHAT_PARAMS='{"extensions":{"Behat\\MinkExtension":{"selenium2":{"wd_host":"http://localhost:4444/wd/hub/", "capabilities": {"chrome":{"binary": "/Applications/Google-Chrome-40.app/Contents/MacOS/Google Chrome", "switches":["--user-data-dir= /Users/jmf3658/tmp/Google Chrome/40/"]}}},"base_url":"http://drupal-kit.local"},"Drupal\\DrupalExtension":{"drush":{"alias":"drupal-kit.local"},"drupal":{"drupal_root":"/Applications/MAMP/htdocs/ut-drupal-kit"}}}}'
