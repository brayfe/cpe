...
Feature: Image Links
  ...
  Scenario: User with correct permissions can add fields
    ...
    And I should see the image path "image-link/placeholder" in the css element ".utexas-image-link img"
    And I should not see the css element ".utexas-image-link a img"
