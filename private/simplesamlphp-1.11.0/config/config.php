...
// Load necessary environmental data from Pantheon variables
...
$config = array (
	 ...
	 * reverse proxy).
	 */
	// Make sure this baseurlpath matches whatever url is in the metadata you sent to the IdP
	// If you change it here, you'll need to send new meatadata
	 ...
	 */
	'auth.adminpassword'		=> 'b9l249rkld8joo8m',
